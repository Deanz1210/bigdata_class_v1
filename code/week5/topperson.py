...
# Load DataFrame
df = pd.read_csv('C:\\Users\\user\\Desktop\\030\\bigdata_class_v1\\code\\week5\\cna_news_preprocessed.csv', sep='|')
...
df_hotPersons.to_csv('C:\\Users\\user\\Desktop\\030\\bigdata_class_v1\\code\\week5\\news_top_person_by_category_via_ner.csv', sep=',', index=False)
