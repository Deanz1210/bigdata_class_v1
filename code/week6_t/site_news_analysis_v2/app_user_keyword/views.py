...
def load_df_data():
    ...
    global  df
    df = pd.read_csv('D:\\Programs\\big_data\\bigdata_class_v1\\code\\week6_t\\site_news_analysis_v2\\app_user_keyword\\dataset\\news_dataset_preprocessed_for_django_12weeks.csv', sep='|')
